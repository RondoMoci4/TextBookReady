...
{
     class DocxToFlowDocunetConvert : DocxReader
    {
        ...
        public DocxToFlowDocunetConvert(Stream stream)
             : base(stream)
        {
        }
        ...
        {
            private readonly DocxToFlowDocunetConvert converter;
            private readonly TextElement previous;

            public CurrentHandle(DocxToFlowDocunetConvert converter, TextElement current)
            {
